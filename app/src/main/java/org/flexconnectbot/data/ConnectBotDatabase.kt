...
package org.flexconnectbot.data
...
import org.flexconnectbot.data.dao.ColorSchemeDao
import org.flexconnectbot.data.dao.HostDao
import org.flexconnectbot.data.dao.KnownHostDao
import org.flexconnectbot.data.dao.PortForwardDao
import org.flexconnectbot.data.dao.PubkeyDao
import org.flexconnectbot.data.entity.ColorPalette
import org.flexconnectbot.data.entity.ColorScheme
import org.flexconnectbot.data.entity.Host
import org.flexconnectbot.data.entity.KnownHost
...
abstract class ConnectBotDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         * Adds encrypted_password column to hosts table.
         */
        private val MIGRATION_1_TO_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE hosts ADD COLUMN encrypted_password BLOB")
            }
        }
